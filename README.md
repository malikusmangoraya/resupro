...
ResuPro AI resume/cv builder SaaS, React+Tailwind, landing/features/blog/pricing/contact/auth, multi-language/multi-currency/GDPR/SEO/JSON-LD, dark mode, responsive, professional footer
